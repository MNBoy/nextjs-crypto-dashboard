    ...
    <div className='flex flex-col h-full lg:flex-row'>
      ...
      <div className='flex flex-col w-full lg:w-4/6'>
        <div className='relative p-2 border-b border-r border-gray-900 h-3/5'>
          Charts
          <div className='absolute items-center justify-center hidden w-48 py-4 -translate-x-1/2 rounded-full cursor-pointer group lg:flex -bottom-6 left-1/2 gap-x-4 bg-blueTheme'>
