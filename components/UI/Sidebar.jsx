    ...
    >
      <div className='flex justify-center mb-8'>
        <svg width='55' height='56' viewBox='0 0 55 56' fill='none' xmlns='http://www.w3.org/2000/svg'>
          <circle cx='27.5' cy='27.5417' r='27.5' fill='#2A4DFF' />
          <path
            d='M27.246 9.158C32.016 9.158 35.9557 10.4123 39.065 12.921C42.2097 15.4297 44.2413 18.8217 45.16 23.097H35.567C34.8603 21.3657 33.765 20.0053 32.281 19.016C30.8323 18.0267 29.101 17.532 27.087 17.532C24.437 17.532 22.2993 18.5037 20.674 20.447C19.0487 22.3903 18.236 24.9873 18.236 28.238C18.236 31.4887 19.0487 34.0857 20.674 36.029C22.2993 37.937 24.437 38.891 27.087 38.891C29.101 38.891 30.8323 38.3963 32.281 37.407C33.765 36.4177 34.8603 35.075 35.567 33.379H45.16C44.2413 37.619 42.2097 41.011 39.065 43.555C35.9557 46.0637 32.016 47.318 27.246 47.318C23.6067 47.318 20.409 46.523 17.653 44.933C14.897 43.3077 12.7593 41.0463 11.24 38.149C9.756 35.2517 9.014 31.948 9.014 28.238C9.014 24.528 9.756 21.2243 11.24 18.327C12.7593 15.4297 14.897 13.186 17.653 11.596C20.409 9.97066 23.6067 9.158 27.246 9.158Z'
            fill='white'
          />
        </svg>
      </div>
