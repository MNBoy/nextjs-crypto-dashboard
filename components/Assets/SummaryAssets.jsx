const Summary = (props) => {
  ...
  return (
    <div className='flex flex-col h-full px-4 justify-evenly gap-y-3'>
      <div className='flex justify-between'>
        <div className='flex items-center gap-x-4'>
          <span className='flex items-center justify-center w-12 h-12 p-2 rounded-full ring-2 ring-green-500 ring-offset-2 ring-offset-bgColor bg-slateTheme'>
          ...
          <div className='flex flex-col'>
            ...
            <span className='text-sm font-light text-gray-500'>RPW</span>
          </div>
        </div>
        <div className='flex flex-col items-end'>
          <span className='text-sm text-gray-500'>
            <strong className='text-lg font-medium text-white'>{inComing.price}</strong> USD
          </span>
      ...
      <div className='flex justify-between'>
        <div className='flex items-center gap-x-4'>
          <span className='flex items-center justify-center w-12 h-12 p-2 rounded-full ring-2 ring-red-500 ring-offset-2 ring-offset-bgColor bg-slateTheme'>
            <svg className='w-6 h-6 fill-white' viewBox='0 0 30 30' fill='none' xmlns='http://www.w3.org/2000/svg'>
          ...
          <div className='flex flex-col'>
            ...
            <span className='text-sm font-light text-gray-500'>RPW (Not Available)</span>
          </div>
        </div>
        <div className='flex flex-col items-end'>
          <span className='text-sm text-gray-500'>
            <strong className='text-lg font-medium text-white'>{outGoing.price}</strong> USD
          </span>
      ...
      <div className='flex justify-between'>
        <div className='flex items-center gap-x-4'>
          <span className='flex items-center justify-center w-12 h-12 p-2 rounded-full ring-2 ring-white ring-offset-2 ring-offset-bgColor bg-slateTheme'>
        ...
        <div className='flex flex-col items-end'>
          <span className='text-sm text-gray-500'>
            <strong className='text-lg font-medium text-white'>{balance.price}</strong> USD
          </span>
